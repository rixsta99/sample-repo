      ...
      <div className="content-container">
        ...
        <div className="text">
          ...
          <ul>
            ...
            <li><b>Modernizing Legacy Workloads:</b> Expertise in migrating legacy workloads (e.g. WSO2, Tibco BW, SSIS) to cloud-native solutions using AWS API Gateway and Lambda (this includes transitional hybrid integration solutions in order to deliver within project budget constraints).</li>
          </ul>
        </div>
      </div>
      <hr />
